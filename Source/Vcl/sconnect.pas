...
uses
  Windows, Messages, Classes, SysUtils, MConnect, ScktComp, WinSock, WinINet;
...
type
  ...
  protected
    ...
    property Interpreter: TDataBlockInterpreter read FInterpreter;
...
uses
  ActiveX, ComObj, MidConst, Forms, Consts;
